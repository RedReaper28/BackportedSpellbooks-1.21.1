...
public class QuickSilverSpellbookItem extends SpellBook {
    public QuickSilverSpellbookItem() {
        super(8, ItemPropertiesHelper.equipment().fireResistant().stacksTo(1).rarity(Rarity.UNCOMMON));
        withSpellbookAttributes(new AttributeContainer(AttributeRegistry.CASTING_MOVESPEED, 0.10, AttributeModifier.Operation.ADD_MULTIPLIED_BASE),
