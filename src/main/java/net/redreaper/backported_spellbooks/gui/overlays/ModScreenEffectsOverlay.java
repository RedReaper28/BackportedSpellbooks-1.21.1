package net.redreaper.backported_spellbooks.gui.overlays;
...
public class ModScreenEffectsOverlay implements LayeredDraw.Layer {
    ...
    public void render(GuiGraphics guiHelper, DeltaTracker deltaTracker) {
        ...
        if (player.hasEffect(ModMobEffects.RESIN_POISON)) {
            renderOverlayAdditive(guiHelper, HEARTSTOP_TEXTURE, 236, 114, 20, .20f, screenWidth, screenHeight);
        }
    }
