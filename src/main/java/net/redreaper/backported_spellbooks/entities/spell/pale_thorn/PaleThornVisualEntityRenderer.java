package net.redreaper.backported_spellbooks.entities.spell.pale_thorn;
...
public class PaleThornVisualEntityRenderer extends EntityRenderer<PaleThornVisualEntity> {

    public static final ModelLayerLocation MODEL_LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(BackportedSpellbooks.MOD_ID, "pale_thorn_model"), "main");
    private static final ResourceLocation TEXTURE_CORE = BackportedSpellbooks.id("textures/entity/pale_thorn/core.png");
    private static final ResourceLocation TEXTURE_OVERLAY = BackportedSpellbooks.id("textures/entity/pale_thorn/overlay.png");

    private final ModelPart body;

    public PaleThornVisualEntityRenderer(EntityRendererProvider.Context context) {
        super(context);
