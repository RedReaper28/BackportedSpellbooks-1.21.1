...
public class SulfurBombRenderer extends EntityRenderer<SulfurBombProjectile> {
    private final static ResourceLocation BASE_TEXTURE = BackportedSpellbooks.id("textures/entity/sulfur_bomb/sulfur_bomb_core.png");
    private final static ResourceLocation FIRE_TEXTURES = BackportedSpellbooks.id("textures/entity/sulfur_bomb/swirl_0.png");

    private final ModelPart orb;
    private final ModelPart swirl;

    public SulfurBombRenderer(EntityRendererProvider.Context context) {
        super(context);
    ...
    @Override
    public void render(SulfurBombProjectile entity, float yaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int light) {
        poseStack.pushPose();
        ...
        consumer = bufferSource.getBuffer(RenderType.entityTranslucent(FIRE_TEXTURES));
    ...
    @Override
    public ResourceLocation getTextureLocation(SulfurBombProjectile entity) {
        return BASE_TEXTURE;
    }

    private ResourceLocation getSwirlTextureLocation(SulfurBombProjectile entity) {
